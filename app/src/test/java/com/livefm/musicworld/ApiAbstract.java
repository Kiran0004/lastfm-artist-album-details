...
public class ApiAbstract<T> {
    ...
    private void enqueueResponse(String fileName, Map<String, String> headers) throws IOException {
        InputStream inputStream = ApiAbstract.class.getClassLoader().getResourceAsStream(String.format("/2.0/", fileName));
    ...
    public T createService(Class<T> clazz) {
        return new Retrofit.Builder()
                .baseUrl(mockWebServer.url("http://ws.audioscrobbler.com/"))
